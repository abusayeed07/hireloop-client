...
export default function JobApplyPage() {
  ...
  // ✅ Client-Side Fetch (Browser automatically sends cookies!)
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        // 2. Fetch Applications (Client Side = Cookie Sent!)
  ...
  if (!job) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-zinc-950 px-4">
        <Card className="p-8 bg-zinc-900 border border-zinc-800 text-center max-w-md">
          <h2 className="text-xl font-bold text-white mb-2">Job Not Found</h2>
          <p className="text-zinc-400 text-sm mb-4">This job listing may have been removed.</p>
  ...
  return (
    <div className="min-h-screen bg-zinc-950 py-8 px-4 md:px-8 mt-15">
      <div className="max-w-4xl mx-auto">
        {/* Back Button */}
        <button onClick={() => router.push(`/browse-jobs/${jobId}`)} className="flex items-center gap-2 text-zinc-400 hover:text-white transition-colors mb-6 group">
        ...
        {!hasReachedLimit ? (
          ...
          <div className="bg-zinc-900/50 border border-zinc-800 rounded-2xl p-12 text-center backdrop-blur-sm">
            ...
            <h3 className="text-xl font-semibold text-white mb-2">Application Limit Reached</h3>
