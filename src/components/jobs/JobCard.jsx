...
const JobCard = ({ job, index }) => {
  ...
  return (
    ...
    >
      <Card className="border border-zinc-800 bg-zinc-950 p-4 hover:border-zinc-700 transition-all duration-300 w-full h-full shadow-lg">
        ...
        <div className="flex items-start gap-3 pb-3 border-b border-zinc-800">
          ...
          <div className="relative h-12 w-12 shrink-0 overflow-hidden rounded-lg bg-zinc-900">
            {job.companyLogo ? (
              ...
              <div className="flex h-full w-full items-center justify-center">
                <House size={24} className="text-zinc-600" />
              </div>
            )}
          </div>
          ...
          {job.isRemote && (
            <Chip
              ...
              variant="flat"
              color="success"
              className="shrink-0 border border-emerald-500/20 bg-emerald-500/10 text-emerald-400"
            >
        ...
        <div className="space-y-2 py-3">
          <div className="grid grid-cols-2 gap-1 text-sm">
            ...
            {/* Salary */}
            <div className="flex items-center gap-1.5 text-zinc-400">
              <FileDollar size={14} className="text-zinc-600" />
